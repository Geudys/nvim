return {
	{
		...
		opts = {
			...
			-- ======================
			templates = {
				subdir = "99 - Templates", -- Carpeta donde están tus plantillas
				date_format = "%Y-%m-%d",
				time_format = "%H:%M",
				substitutions = {
					Date = function()
		...
		config = function(_, opts)
			...
			-- ======================
			-- CREAR DAILY NOTE AUTOMÁTICA
			-- ======================
			map("n", "<leader>od", function()
				-- Carpeta donde se guardan las notas diarias
				local daily_dir = "/mnt/c/My Desktop/GPS/Obsidian/06 - Daily/Daily 2025/Daily 2025-10/"
				-- Nombre con formato "Daily YYYY-MM-DD"
